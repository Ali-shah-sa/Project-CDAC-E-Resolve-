...
import { handleLogin } from '../../../utils/handleLogin'; // ✅ use shared handler
...
// const [user, setUser] = useState(null); // ✅ Add this
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    setShowError(false);
  handleLogin({ email, password }, 'admin', navigate, setShowError);
  };
        ...
        <div className="bg-white p-8 rounded-lg shadow-sm border border-gray-200">
          {showError && (
            <div
              ...
              role="alert"
            >
              Invalid admin credentials or role mismatch
            </div>
          )}
